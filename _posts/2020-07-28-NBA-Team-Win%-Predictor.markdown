...
2. Built NBA Team dashboards with 15 years of trends around key statistics that impact win %
...
Part 1: Developed model that predicts team win% based on 9 key variables
